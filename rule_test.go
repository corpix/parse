...
func (r *testRuleFinite) Parse(ctx *Context, input []byte, hooks ...RuleParseHook) (*Tree, error) {
	return &Tree{
...
func (r *testRuleNonFinite) Parse(ctx *Context, input []byte, hooks ...RuleParseHook) (*Tree, error) {
	return &Tree{
		Location: &Location{Path: ctx.Location.Path},
		Region:   &Region{},
		Rule:     r,
